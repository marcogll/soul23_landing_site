...
export default function Section10Footer() {
  ...
  const legalLinks = [
    ...
    { label: t('footer.planes'), to: '/precios' },
    { label: t('footer.privacidad'), to: '/privacidad' },
    { label: t('footer.reembolso'), to: '/reembolso' },
    { label: t('footer.terminos'), to: '/terminos' },
  ]
  ...
  return (
    <footer ref={sectionRef} className="relative w-full bg-dark-primary py-12 px-6" style={{ zIndex: 100 }}>
      <div className="max-w-4xl mx-auto flex flex-col items-center text-center">
        ...
        <p className="reveal text-sm text-cream-muted mb-6">
          {t('footer.tagline')}
        </p>

        <div className="reveal flex flex-wrap justify-center gap-x-4 gap-y-1 mb-5 text-xs text-cream-muted/55">
        ...
        <nav className="reveal flex flex-wrap justify-center gap-x-5 gap-y-1 mb-6">
